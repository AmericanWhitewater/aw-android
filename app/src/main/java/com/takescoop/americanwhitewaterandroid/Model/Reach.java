...
//    @Expose @SerializedName("gauge_important") // How gauges compete to be the primary
...
//    private String units;
    ...
    public String getGaugeComment() {
        return gaugeComment;
    }

    public String getLastJournalUpdate() {
        return lastJournalUpdate;
    }
